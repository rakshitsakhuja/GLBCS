...
<head>
	<meta charset="UTF-8">
	<title>iccs2015 login panel</title>
			...
			<div id="section">
			  <h3>Login panel</h3>
				<form name="form1" method="post" action="logincheck.jsp">
                  <p>
                    <label>Account Type: 
                    <select name="menu1" id="menu1" disabled>
                  ...
                  <p><br>
                      <font color="Red"><I>Invalid userid and password</I></font>
                      </p>
				</form>
<p>
				...
				<div>
					...
					<div>
						...
						<a href="heart-monitoring-procedure.html" class="more">more info</a>
					</div>
				</div>
			</div>
		</div>
